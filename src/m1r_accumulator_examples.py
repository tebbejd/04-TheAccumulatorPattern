...
#                  count = 0 should be outside of the for loop
#                  if math.cos(r) > 0: should be math.cos(k) > 0
#                      count = 1 should be adding the previous count so it should be count = count + 1
#                  return count should be outside the for loop
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?
#               it means that it does not use the index variable
